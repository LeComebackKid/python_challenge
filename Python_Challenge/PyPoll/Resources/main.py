...
with open("file_to_save.txt", "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > largest_county_votes) and (county_vote_percentage > win_county_percentage):
            largest_county_votes = county_votes
            winning_county = county_name
            win_county_percentage = county_vote_percentage
